...
namespace SeleniumTest
{
    ...
    public class Selenium
    {
        ...
        public void FireFoxTest()
        {
            ...
            //select a model with id of 23194

            selectChildFrame.Invoke("//iframe[contains(@id, 'iframeMDSrchResults')]");
            selectChildFrame.Invoke("//frame[contains(@name, 'ModelSearchResults')]");
            click.Invoke("//div[contains(@id, 'modelSearchResults-item-23194')]");
            driver.FindElement(By.XPath("//div[contains(@id, 'modelSearchResults-item-23194')]//div//div/ul/li/a")).Click();
        }
